...
- [Private audio meeting notes with FunASR](./third_party/FunASR/funasr_claude_meeting_notes.ipynb): Transcribe audio locally, then use Claude for structured notes.
